  ...
  var scrollMotion = function () {
    ...
    rafId = requestAnimationFrame(function(){
      ...
      $('.home-promotion figure').each(function(){
        ...
        let meta = 1 + Math.abs(scry - (t - winh*.5 + h*.5)) * -0.0007
        if(meta < 0) meta = 0;
        $(this).children('.inner').css({'transform':`scale(${meta})`,
        'opacity':meta,
      })
      })//each
      //code end
...
$(function(){//scrollspy
  ...
  var scrollMotion = function () {
    ...
    rafId = requestAnimationFrame(function(){
      //code start
      let t1 = $('.home-section1').offset().top
      let t2 = $('.home-section2').offset().top
      let t3 = $('.home-section3').offset().top
      let t4 = $('.home-section4').offset().top
      let t5 = $('.home-section5').offset().top
      let t6 = $('.home-section6').offset().top
      let c
      if(scry < t2-1){
        c = 1
