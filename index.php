  ...
  <section class="home-works home-section3">
    <div class="center">
      ...
      <a class="more" href="./works.php">
        제작사례 전체보기<i class="fa-solid fa-arrow-right"></i>
      </a>
    </div>
  </section>
  ...
  <section class="home-service home-section4">
    <div class="center">
      ...
      <div class="service-carousel">
        <div class="swiper-wrapper"> <!-- 넓이x, 높이x -->
